...
export default function UserCalendarPage() {
  ...
  const userEvents = useMemo(() => {
    return mockEvents.filter((e) => e.userId === user?.id)
  }, [user])
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">View your event history and schedule</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          {viewMode === "calendar" ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>List of all your events in selected range</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Your Events by Type</CardTitle>
            <CardDescription>Distribution of your event types</CardDescription>
          </CardHeader>
          <CardContent>
