  ...
  useEffect(() => {
    ...
    if (found) {
      ...
      setStream({
        ...
        streamName: "live",
        rtmpUrl: found.rtmpUrl || `rtmp://stream.streamlivee.com/live/event-${eventId}`,
        streamKey: found.streamKey || `sk_${eventId}_live`,
        hlsPlaybackUrl: found.hlsUrl || `https://cdn.streamlivee.com/event-${eventId}/live/playlist.m3u8`,
