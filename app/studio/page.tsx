...
export default function StudioDashboard() {
  ...
  const swrKey = user && user.role === "studio" ? "/api/studio/dashboard" : null
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen">
        <Header title="Studio Dashboard" subtitle="Loading…" />
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription className="flex flex-wrap items-center gap-2">
              ...
              <Button variant="outline" size="sm" className="bg-transparent" asChild>
                <Link href="/studio/wallet">Add funds</Link>
              </Button>
            </AlertDescription>
          </Alert>
        )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-end pt-2">
                    <Button size="sm" variant="outline" className="border-border bg-transparent" asChild>
                      <Link href="/studio/packages">Buy more credits</Link>
                    </Button>
                  </div>
                </div>
              ) : (
        ...
        <Card className="border-border bg-card">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button size="sm" variant="ghost" className="text-primary shrink-0" asChild>
              <Link href="/studio/wallet">View all</Link>
            </Button>
          </CardHeader>
          <CardContent>
            {isLoading ? (
