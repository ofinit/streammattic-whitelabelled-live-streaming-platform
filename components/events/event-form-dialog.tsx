...
export function EventFormDialog({
  ...
  const [isPrivateEventCompliant, setIsPrivateEventCompliant] = useState(true)
  ...
  useEffect(() => {
    ...
    if (event) {
        ...
        const eventTimezone =
          (typeof ev.timezone === "string" && ev.timezone.trim()) ||
          "Asia/Kolkata"
        ...
        setFormData({
          ...
          allowChat: coerceEventBooleanFlag(
            (event as unknown as Record<string, unknown>).allowChat,
            (event as unknown as Record<string, unknown>).allow_chat,
            false,
          ),
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 pb-24 sm:pb-6">
            ...
            <TabsContent value="stream" className="space-y-4 mt-4">
              <div className="space-y-2">
                ...
                {formData.streamType === "rtmp" && (
                  <div className="flex items-start gap-2.5 p-3 rounded-lg border border-amber-500/30 bg-amber-500/5 mt-3">
                    <Checkbox
                      id="private-event-compliance"
                      checked={isPrivateEventCompliant}
                      onCheckedChange={(checked) => setIsPrivateEventCompliant(!!checked)}
                      className="mt-0.5"
                    />
