    ...
    const features = [
        {
            ...
            description: `Host your own scalable live streaming platform. Your logo, your brand colors, and your custom domain (e.g., live.yourstudio.com). Completely hide the ${branding.brandName} engine.`,
            icon: Palette,
                ...
                <section className="relative px-6 pt-20 pb-32 text-center overflow-hidden">
                    ...
                    <div className="mx-auto max-w-5xl relative z-10">
                        <div className="inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-sm text-primary mb-8 animate-in fade-in slide-in-from-bottom-5 duration-1000">
                            ...
                            {branding.brandName} 2.0 is Live
                        </div>
                ...
                <section id="features" className="px-6 py-24 bg-card/20 border-y border-border/40">
                    <div className="mx-auto max-w-7xl">
                        <div className="text-center mb-20 max-w-3xl mx-auto">
                            ...
                            <p className="text-lg text-muted-foreground">{branding.brandName} turns your single web-server into a fully fledged streaming agency. We provide the architecture, you provide the vision.</p>
                        </div>
