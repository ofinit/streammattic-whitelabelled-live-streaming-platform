...
function OrnateRoseWreath() {
  return (
    <svg viewBox="0 0 300 90" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Overlay decorative petals for organic shape */}
      ...
      {/* Mini gold accents and filler leaf paths */}
...
export function WeddingOrnateFloralTemplate({
  ...
  const hero = heroImageUrl?.trim() || getDefaultTemplateHeroBackdropUrl("tpl-wedding-ornate-floral") || ""
  ...
  const scrollToStream = () =>
    document.getElementById("ornate-preview-stream")?.scrollIntoView({ behavior: "smooth", block: "start" })
  ...
  return (
    <div className="wedding-ornate-floral-skin">
      ...
      <section className="ornate-hero">
        <div className="ornate-couple-circle-wrapper">
          <div className="ornate-gold-ring-outer" />
          <div className="ornate-gold-ring" />
          <div className="ornate-couple-circle">
            <img src={hero} alt={eventTitle} />
          </div>
          <div className="ornate-wreath">
            <OrnateRoseWreath />
          </div>
        </div>
      ...
      {/* Live Stream Section */}
      <section id="ornate-preview-stream" className="ornate-section">
      ...
      <footer className="ornate-footer">
        <h2>Thank You</h2>
        <p>Template Preview · Ornate Floral Wedding</p>
      </footer>
    </div>
  )
}
