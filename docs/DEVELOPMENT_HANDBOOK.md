...
| `app/api/admin/orders/[id]/process/route.ts` | `/api/admin/orders/[id]/process` |
...
| `app/api/admin/users/[id]/engagement/route.ts` | `/api/admin/users/[id]/engagement` |
| `app/api/admin/users/[id]/photo-gallery/route.ts` | `/api/admin/users/[id]/photo-gallery` |
| `app/api/admin/users/[id]/reset-password/route.ts` | `/api/admin/users/[id]/reset-password` |
...
| `app/api/admin/users/engagement/campaign/route.ts` | `/api/admin/users/engagement/campaign` |
...
| `app/api/client-gallery/albums/[id]/camera-ingest/[credentialId]/route.ts` | `/api/client-gallery/albums/[id]/camera-ingest/[credentialId]` |
| `app/api/client-gallery/albums/[id]/camera-ingest/route.ts` | `/api/client-gallery/albums/[id]/camera-ingest` |
...
| `app/api/client-gallery/camera-ingest/import/route.ts` | `/api/client-gallery/camera-ingest/import` |
...
| `app/api/generate-token/route.ts` | `/api/generate-token` |
| `app/api/gst/config/route.ts` | `/api/gst/config` |
| `app/api/health/route.ts` | `/api/health` |
| `app/api/internal/srs/merge-complete/route.ts` | `/api/internal/srs/merge-complete` |
...
| `app/api/publish/route.ts` | `/api/publish` |
| `app/api/refunds/route.ts` | `/api/refunds` |
| `app/api/settings/crew-pin-display/route.ts` | `/api/settings/crew-pin-display` |
...
| `app/api/unpublish/route.ts` | `/api/unpublish` |
...
| `app/api/watch/[eventId]/rtmp-source/route.ts` | `/api/watch/[eventId]/rtmp-source` |
