...
export const mockTransactions: WalletTransaction[] = [
  ...
  },
  {
    ...
    balanceBefore: 20000,
    balanceAfter: 19000,
    description: "Cascade debit - Professional Package (User: Alice Johnson)",
    referenceId: "order-1",
    referenceType: "ORDER",
    cascadeLevel: 1,
    createdAt: new Date("2024-11-15T10:30:00"),
  },
  {
    ...
    balanceBefore: 19000,
    balanceAfter: 18500,
    description: "Cascade debit - Starter Package (User: Bob Smith)",
    referenceId: "order-2",
    referenceType: "ORDER",
    cascadeLevel: 1,
...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Bob Smith has placed an order for Starter package",
    type: "warning",
    isRead: false,
  ...
  },
  {
    ...
    message: "Successfully received ₹11,800 via Razorpay",
    type: "success",
    isRead: false,
