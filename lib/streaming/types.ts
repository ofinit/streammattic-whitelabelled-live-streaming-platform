...
export const BACKEND_INFO: Record<StreamingBackendType, StreamingBackendInfo> = {
  ...
  fivecentscdn: {
    ...
    features: [
      ...
      "Wasabi Critical Backup storage",
      "Global CDN delivery",
      "RTMP authentication",
    ...
    helpTexts: {
      ...
      storagePath: "Recordings are managed by 5CentsCDN DVR/record settings. Long-term copies should be configured in 5CentsCDN Critical Backup with Wasabi Object Storage.",
