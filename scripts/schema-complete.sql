...
-- =============================================================
-- TABLE: client_gallery_camera_ingest_credentials
-- =============================================================
...
-- =============================================================
-- TABLE: client_gallery_person_identities (face grouping per album)
-- =============================================================
...
-- =============================================================
-- TABLE: client_gallery_face_instances
-- =============================================================
...
-- =============================================================
-- TABLE: client_gallery_storage_settings (per-user BYOS S3)
-- =============================================================
...
-- =============================================================
-- TABLE: event_visitor_sessions (page-load analytics, high write volume)
-- =============================================================
...
-- =============================================================
-- TABLE: analytics_funnel_events (append-only funnel steps)
-- =============================================================
...
-- (No default admin user: create one with scripts/seed-production-admin.js
--  or invite a user and promote role in the database.)
-- =============================================================
INSERT INTO platform_settings (key, value) VALUES
  ...
  ('photo_gallery_addon', '{"listingEnabled":false,"productName":"Client photo gallery","galleryPath":"/client-gallery","galleryServiceBaseUrl":"","monthlyPricePaisa":0,"faceIndexCreditPricePaisa":500,"faceRecognitionProviderCostReferencePaisa":0,"faceIndexOpenRouterModelId":"google/gemini-2.0-flash-001"}'::jsonb)
